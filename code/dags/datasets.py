...
etl_datasets = [
    ...
    PostgresDataset(name="code_postal_source", **etl_default_args),
    PostgresDataset(name="code_postal", **etl_default_args),
    PostgresDataset(name="sis_source", **etl_default_args),
    PostgresDataset(name="sis_filtered", **etl_default_args),
    PostgresDataset(name="sis_geocoded", **etl_default_args),
    PostgresDataset(name="sis_with_precision", **etl_default_args),
    PostgresDataset(name="sis_with_version", **etl_default_args),
    PostgresDataset(name="sis", **etl_default_args),
    PostgresDataset(name="basol_source", **etl_default_args),
    PostgresDataset(name="basol_filtered", **etl_default_args),
    ...
    PostgresDataset(name="basol_with_version", **etl_default_args),
    PostgresDataset(name="basol", **etl_default_args),
    PostgresDataset(name="s3ic_source", **etl_default_args),
    PostgresDataset(name="s3ic_idf_source", **etl_default_args),
    PostgresDataset(name="s3ic_without_idf", **etl_default_args),
    PostgresDataset(name="s3ic_idf_with_geog", **etl_default_args),
    PostgresDataset(name="s3ic_stacked", **etl_default_args),
    PostgresDataset(name="s3ic_filtered", **etl_default_args),
    PostgresDataset(name="s3ic_scraped", **etl_default_args),
    PostgresDataset(name="s3ic_geocoded", **etl_default_args),
    PostgresDataset(name="s3ic_normalized", **etl_default_args),
    PostgresDataset(name="s3ic_geog_merged", **etl_default_args),
    PostgresDataset(name="s3ic_intersected", **etl_default_args),
    PostgresDataset(name="s3ic_with_commune", **etl_default_args),
    PostgresDataset(name="s3ic_with_version", **etl_default_args),
    PostgresDataset(name="s3ic", **etl_default_args),
    PostgresDataset(name="basias_sites_source", **etl_default_args),
    PostgresDataset(name="basias_sites_filtered", **etl_default_args),
    PostgresDataset(name="basias_localisation_source", **etl_default_args),
    PostgresDataset(name="basias_localisation_filtered", **etl_default_args),
    ...
    PostgresDataset(name="basias_cadastre_filtered", **etl_default_args),
